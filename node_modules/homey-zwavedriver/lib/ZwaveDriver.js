				...
				options_capability.forEach((options_capability_item) => {
					...
					if( typeof options_capability_item.multiChannelNodeId === 'number' ) {
						if( typeof instance.CommandClass[ options_capability_item.command_class ] === 'undefined' )
							throw new Error('invalid_commandClass_' + options_capability_item.command_class + '_for_multiChannelNodeId_' + options_capability_item.multiChannelNodeId);
					} else {
						if( typeof instance.CommandClass[ options_capability_item.command_class ] === 'undefined' )
							throw new Error('invalid_commandClass_' + options_capability_item.command_class);
					}
